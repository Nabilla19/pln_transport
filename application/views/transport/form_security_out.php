...
function takeSnapshot() {
    ...
    if (currentTarget === 'driver') {
        document.getElementById('img_driver_kembali').src = dataUrl;
        document.getElementById('preview_driver_kembali').style.display = 'block';
        document.getElementById('capture_driver_input').value = dataUrl;
        document.getElementById('foto_driver_kembali').value = ''; // Clear file input
    } else {
        document.getElementById('img_km_kembali').src = dataUrl;
        document.getElementById('preview_km_kembali').style.display = 'block';
        document.getElementById('capture_km_input').value = dataUrl;
        document.getElementById('foto_km_kembali').value = ''; // Clear file input
    }
...
setupImagePreview('foto_driver_kembali', 'preview_driver_kembali', 'img_driver_kembali', 'capture_driver_input');
setupImagePreview('foto_km_kembali', 'preview_km_kembali', 'img_km_kembali', 'capture_km_input');
</script>
