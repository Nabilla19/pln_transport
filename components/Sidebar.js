...
export default function Sidebar() {
    ...
    const navItems = [
        ...
        { label: 'Manajemen Fleet', href: '/my-requests?filter=fleet', icon: '🚗', show: isKKU, filter: 'fleet' },
        { label: 'Pos Security', href: '/my-requests?filter=security', icon: '👮', show: true, filter: 'security' },
